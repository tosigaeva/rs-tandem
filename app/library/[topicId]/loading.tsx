...
export default function WidgetListSkeleton() {
        ...
        <ul className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {skeletonItems.map((item) => (
            <li key={item} className="overflow-visible">
              <Card className="group hover:ring-primary/40 hover:ring-offset-background border-secondary/50 flex h-40 cursor-pointer flex-row items-center gap-4 px-4 py-2 transition-all duration-300 ease-out hover:shadow-lg hover:ring-2 hover:ring-offset-2">
